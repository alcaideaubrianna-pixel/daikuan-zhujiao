...
const input=ref(''),typing=ref(false),messages=ref<Message[]>([{id:1,from:'agent',text:'您好，我是快贷在线客服。请问有什么可以帮您？',time:'现在'}])
